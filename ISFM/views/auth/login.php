...
<html lang="en" >
    ...
    <body class="login">
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
            <center>Download free scripts, visit: <a href="https://www.youtube.com/channel/UC_UgiwaNHxAfzg-LXJlLc0A" target="_blank">Developer Man</a></center>
            <br>
            <h4>Adwanced School Management System</h4>
        </div>
        <!-- END COPYRIGHT -->
